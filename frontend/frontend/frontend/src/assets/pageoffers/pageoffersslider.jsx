import OffersCardspage from './cards/pageoffer';
import React, { useState } from 'react';
import { MdArrowForwardIos, MdArrowBackIosNew } from "react-icons/md";
import '../couponscards/couponcardslider.css';

function Offerpagecardslide({ cardsObject = [] }) {
        ...
        <div className="couponpagecardslide-wrapper">
          <div className={`offerpagecardslide-content ${animationClass}`}>
            {cardsObject
              ...
              .map((cardData, index) => (
                cardData && <OffersCardspage key={index} {...cardData} />
              ))}
          </div>
...
export default Offerpagecardslide;
